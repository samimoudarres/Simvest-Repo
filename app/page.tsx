...
export default function TradingApp() {
  return (
    <div className="flex flex-col min-h-screen bg-[#f7f7f7] max-w-md mx-auto">
      ...
      {/* Bottom Navigation */}
      <div className="flex justify-between items-center p-3 border-t border-gray-200 bg-white sticky bottom-0 z-10">
        <Link href="#" className="flex flex-col items-center text-[#777777] px-2">
          <div className="w-6 h-6 mb-1">⏱️</div>
          <span className="text-xs">ACTIVITY</span>
        </Link>
        <Link href="#" className="flex flex-col items-center text-black px-2">
          <div className="w-6 h-6 mb-1">📊</div>
          <span className="text-xs font-bold">PERFORM.</span>
        </Link>
        <Link href="#" className="flex flex-col items-center text-[#777777] relative px-2">
          <div className="w-14 h-14 bg-[#f7b104] rounded-full flex items-center justify-center absolute -top-7">
            <span className="text-white text-2xl">$</span>
          </div>
          <span className="text-xs mt-7">TRADE</span>
        </Link>
        <Link href="#" className="flex flex-col items-center text-[#777777] px-2">
          <div className="w-6 h-6 mb-1">📁</div>
